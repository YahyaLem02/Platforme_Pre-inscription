...
<style>
    ...
    .actualite-image {
        ...
        max-height: 50px;
        height: 100%;
        /* Take up 100% of the height of the container */
        object-fit: cover;
                ...
                <div class="col-md-6 col-lg-3 actualite-box">
                    <div class="actualite-details">
                        ...
                        <button class="btn btn-primary"
                            onclick="afficherModal('<?= $description ?>', '<?= $image ?>', '<?= $titre ?>', '<?= $nomComplet ?>', '<?= $NomDep ?>')">Voir
                            plus</button>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="descriptionModalLabel">Description de l'Actualité</h5>
