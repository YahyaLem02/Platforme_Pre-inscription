...
<body>
    <?php include '../headerCandidat.php'; ?>
    <div>
        <h1>Multiform</h1>
        <div id="multi-step-form-container">
            ...
            <ul class="form-stepper form-stepper-horizontal text-center mx-auto pl-0">
                ...
                <li class="form-stepper-unfinished text-center form-stepper-list" step="3">
                    <a class="mx-2">
                        ...
                        <div class="label text-muted">Diplome</div>
                    </a>
                </li>
                <!-- Step 3 -->
            ...
            <form id="userAccountSetupForm" name="userAccountSetupForm" enctype="multipart/form-data" method="POST"
                ...
                <section id="step-1" class="form-step">
                    ...
                    <div class="mt-3">
                        <label for="prenom">Apogée (Facultatif):</label>
                        ...
                        <div class=" bac mt-3">
                            <div class="bac-details mt-3">
                                <div class="input-group">
                                    <label for="anneeBac">Année du Baccalauréat:</label>
                                ...
                                <div class="input-group">
                                    <label for="noteBac1">Note au Baccalauréat:</label>
                            ...
                            <div class="bac-details mt-3">
                                <div class="input-group">
                                    ...
                                    ?>
                                    <label for="academieBac1">Académie :</label>
                                ...
                                <div class="input-group">
                                    ...
                                    ?>
                                    <label for="mention1">Mention :</label>
                        ...
                        <div class="diplome-details mt-3">
                            ...
                            <div class="annee-details mt-3">
                                <div class="input-group">
                                    ...
                                    ?>
                                    <label for="mention1">Mention :</label>
                                    <select name="mentionDiplome" id="mention1" required>
                                        <option value="">Choisissez une option</option>
                                        <?php foreach ($mentions as $mention) : ?>
                                        <option value="<?php echo $mention->getAttribute('idMention'); ?>">
                                            <?php echo $mention->nodeValue; ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="TypeFormation" id="TypeFormation" onchange="showFields()" required>
                                        <option value="">Choisissez une option</option>
                                        <?php foreach ($TypeFormations as $TypeFormation) : ?>
                                ...
                                <div class="formation1-3" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="" id="typeEtablissement"
                                            onchange="showEtablissements()">
                                            <option value="">Choisissez une option</option>
                                            <?php foreach ($TypesEtablissements as $TypesEtablissement) : ?>
                                ...
                                <div class="formation4-5" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        ?>
                                        <label for="typeCentre">Type de centre :</label>
                                        <select name="" id="typeCentre" onchange="showCentres()">
                                            <option value="">Choisissez une option</option>
                                ...
                                <div class="input-group">
                                    ...
                                    ?>
                                    <label for="FiliereDiplome">Filière du diplome :</label>
                                    <select name="FiliereDiplome" id="FiliereDiplome">
                                        <option value="">Choisissez une option</option>
                                        <?php foreach ($FiliereDiplomes as $FiliereDiplome) : ?>
                            ...
                            <div class="annee-details mt-3">
                                ...
                                <label for="InofsPremiereAnnee-annee">Année:</label>
                            ...
                            <div class="annee-details mt-3">
                                ...
                                <label for="InofsDouxiemeAnnee-annee">Année:</label>
                ...
                <section id="step-4" class="form-step d-none">
                    ...
                    <div class="experience-details mt-3">
                        ...
                        <label for="experiencePro">Expérience Professionnelle:</label>
                        <textarea id="experiencePro" name="experiencePro" required rows="6"></textarea>

                        <!-- Champ pour le nombre d'années d'expérience -->
                        <label for="nombreAnne">Nombre d'années d'expérience:</label>
                ...
                <section id="step-5" class="form-step d-none">
                    ...
                    <div class="file-details mt-3">
                        ...
                        <label for="attestation">Attestation de réussite ou diplôme:</label>
                        <input type="file" id="attestation" name="diplomeBac2" accept=".jpg,.png,.jpeg" required>

                        <!-- Relevé de notes S1 -->
                        <label for="releveS1">Relevé de notes S1:</label>
                        <input type="file" id="releveS1" name="releveeDeNotes1" accept=".jpg,.png,.jpeg" required>

                        <!-- Relevé de notes S2 -->
                        <label for="releveS2">Relevé de notes S2:</label>
                        <input type="file" id="releveS2" name="releveeDeNotes2"accept=".jpg,.png,.jpeg" required>
                        ...
                        <!-- Copie de CIN -->
                        <label for="cinCopy">Copie de CIN:</label>
